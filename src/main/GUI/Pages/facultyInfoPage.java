...
public class facultyInfoPage extends JFrame {
	...
	public facultyInfoPage() {
		...
		// + " <body>\r\n"
		// + " <p>Contact:</p>\r\n"
		// + " <p>Representatives of the Admissions Office are happy to answer your
		// questions or to meet with you to for an advising appointment to discuss your
		// application.</p>\r\n"
		// + " <p>Current Osgoode students are another great source of information and
		// guidance for prospective and newly admitted students. To speak with one of
		// our Student Ambassadors. Import content from or to arrange a tour, please
		// contact our Student Recruitment Coordinator at
		// recruitment@osgoode.yorku.ca.</p>\r\n"
		...
		// + " <p><a href='http://www.yorku.ca/maps/'>Click here</a> to find the Ignat
		// Kaneff Building on an interactive campus map of York University.</p>\r\n"
		...
		// + " Marcos Ramos Jr, Manager, Admissions & Financial Services �
		// mramos@osgoode.yorku.ca<br>\r\n"
		// + " Louise Resendes, Recruitment & Admissions Officer �
		// lresendes@osgoode.yorku.ca<br>\r\n"
		// + " Vicky Faclaris, Recruitment & Admissions Coordinator �
		// vfaclaris@osgoode.yorku.ca<br>\r\n"
